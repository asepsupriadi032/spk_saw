...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="<?php echo base_url('admin/dashboard'); ?>">Admin - PENERAPAN METODE SIMPLE ADDITIVE WEIGHTING (SAW) REKOMENDASI UNTUK PENGANGKATAN PEGAWAI KONTRAK <?php //echo $this->session->userdata('nama'); 
                                                                                                                                                                                        ?></a>
</div>
